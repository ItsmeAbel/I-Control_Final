...
public class Level3 extends AppCompatActivity {
    ...
    private int imageNo[]={R.drawable.hexagon,R.drawable.square,R.drawable.triangle,R.drawable.circle,R.drawable.cube,R.drawable.diamond};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ImageSwitcher imageSwitcher = (ImageSwitcher) findViewById(R.id.imageChanger3);
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (timeRemain == 0){
                    ...
                    Intent i = new Intent(Level3.this,NextReplay3.class);
                    //starts new activity
                    startActivity(i);
                    finish();
                }
