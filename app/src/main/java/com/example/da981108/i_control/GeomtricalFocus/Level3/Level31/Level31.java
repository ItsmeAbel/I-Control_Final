...
public class Level31 extends AppCompatActivity {
    ...
    private int imageNo[]={R.drawable.hexagon,R.drawable.square,R.drawable.cube,R.drawable.triangle,R.drawable.diamond,R.drawable.circle};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ImageSwitcher imageSwitcher = (ImageSwitcher) findViewById(R.id.imageChanger31);
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (timeRemain == 0){
                    ...
                    Intent i = new Intent(Level31.this,NextReplay31.class);
                    //starts new activity
                    startActivity(i);
                    finish();
                }
