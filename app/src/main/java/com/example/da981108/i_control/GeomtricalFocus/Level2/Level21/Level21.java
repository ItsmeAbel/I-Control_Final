...
public class Level21 extends AppCompatActivity {
    ...
    private int imageNo[]={R.drawable.cube,R.drawable.triangle,R.drawable.square,R.drawable.hexagon};
    //counting Image
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ImageSwitcher imageSwitcher = (ImageSwitcher) findViewById(R.id.imageChanger21);
        ...
        final Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (timeRemain == 0){
                    ...
                    Intent i = new Intent(Level21.this,NextReplay21.class);
                    //starts new activity
                    startActivity(i);
                    finish();
