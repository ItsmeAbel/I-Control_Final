...
public class Level12 extends AppCompatActivity {
    ...
    private int imageNo[]={R.drawable.cube,R.drawable.diamond,R.drawable.hexagon}; //square
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ImageSwitcher imageSwitcher = (ImageSwitcher) findViewById(R.id.imageChanger12);
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (timeRemain == 0){
                    ...
                    Intent i = new Intent(Level12.this,NextReplay12.class);
                    //starts new activity
                    startActivity(i);
                    finish();
                }
