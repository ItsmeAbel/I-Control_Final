...
public class Level1 extends AppCompatActivity {
    ...
    private int imageNo[]={R.drawable.cube,R.drawable.triangle,R.drawable.circle}; //square
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ImageSwitcher imageSwitcher = (ImageSwitcher) findViewById(R.id.imageChanger1);
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (timeRemain == 0){
                    ...
                    Intent i = new Intent(Level1.this,NextReplay.class);
                    //starts new activity
                    startActivity(i);
                    finish();
                }
