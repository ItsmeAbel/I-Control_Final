...
public class Level32 extends AppCompatActivity {

    //add image to drawable and fetch here
    private int imageNo[]={R.drawable.diamond,R.drawable.triangle,R.drawable.hexagon,R.drawable.cube,R.drawable.square,R.drawable.circle};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ImageSwitcher imageSwitcher = (ImageSwitcher) findViewById(R.id.imageChanger32);
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (timeRemain == 0){
                    ...
                    Intent i = new Intent(Level32.this,NextReplay32.class);
                    //starts new activity
                    startActivity(i);
                    finish();
                }
