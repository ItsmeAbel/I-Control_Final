...
public class Level22 extends AppCompatActivity {
    ...
    private int imageNo[]={R.drawable.triangle,R.drawable.circle,R.drawable.cube,R.drawable.diamond};
    //counting Image
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ImageSwitcher imageSwitcher = (ImageSwitcher) findViewById(R.id.imageChanger22);
        ...
        final Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (timeRemain == 0){
                    ...
                    Intent i = new Intent(Level22.this,NextReplay22.class);
                    //starts new activity
                    startActivity(i);
                    finish();
