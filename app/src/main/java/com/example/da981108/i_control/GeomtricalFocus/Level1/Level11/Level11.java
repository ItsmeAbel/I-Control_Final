...
public class Level11 extends AppCompatActivity {
    ...
    private int imageNo[]={R.drawable.diamond,R.drawable.triangle,R.drawable.square};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ImageSwitcher imageSwitcher = (ImageSwitcher) findViewById(R.id.imageChanger11);
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (timeRemain == 0){
                    ...
                    Intent i = new Intent(Level11.this,NextReplay11.class);
                    //starts new activity
                    startActivity(i);
                    finish();
                }
